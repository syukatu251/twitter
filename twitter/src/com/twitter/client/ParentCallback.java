 ...
 * ParentCallback.java
 * 
 * The parent of ParallelCallback objects, used when 2 or more service calls should run in
 * parallel, and only when each is complete should something happen. The parent waits till all
 * children are done, then kicks off the handleSuccess().
 * 
 * @author Ben Northrop
 */
